...
# 文件路径
first_output_file = '/fs-computility/ai4sData/zhaoxiangyu1/neurips_mmearth_benchmark/merge_open_caption.jsonl'
second_output_file = '/fs-computility/ai4sData/zhaoxiangyu1/neurips_mmearth_benchmark/merge_open_caption_no_caption.jsonl'

# 合并数据的列表
data_with_caption = []

# 获取所有以 qwen 开头的 jsonl 文件
jsonl_files = [f for f in os.listdir(folder_path) if f.startswith('qwen') and f.endswith('.jsonl')]
...
for file in jsonl_files:
    ...
    with open(file_path, 'r') as f:
        for line in f:
            ...
            # 添加 question_id 字段，格式化为 N000001、N000002 等
            data['question_id'] = f"N{current_id:06d}"
...
# 计算采样数量
short_sample_count = 250  # 20% 的数据
long_sample_count = 2250  # 80% 的数据
