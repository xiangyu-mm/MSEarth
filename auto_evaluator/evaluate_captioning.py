...
def get_answer_prompt(query, caption=None):
    ...
    if caption is None:
        ...
        Please analyze the image carefully and provide a comprehensive caption.
...
if __name__ == '__main__':
    ...
    parser.add_argument("--test", type=str, default='/neurips_mmearth_benchmark/captioning_sample.jsonl')
