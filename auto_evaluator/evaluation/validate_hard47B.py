...
class Dataset_all:
    def __init__(self, 
                file_path = '/fs-computility/ai4sData/zhaoxiangyu1/neurips_mmearth_benchmark/filtered_questions.jsonl',
...
if __name__ == '__main__':
    ...
    save_dir1 = os.path.join(args.save_dir, f"mcq_result_normal.jsonl")
