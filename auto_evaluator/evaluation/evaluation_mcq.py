...
def fetch_response(input_text, base64_image, model_name="Qwen2.5-VL-72B-Instruct", timeout=60):
    """
    发送请求到模型服务，并设置超时时间。
    """
    def send_request():
    ...
    def get_dataset(self, file):
        ...
        if self.question_type == "MCQ":
            try:
                ...
                response1 = fetch_response(input1, base64_image, self.model_name, timeout=60)
...
if __name__ == '__main__':
    ...
    save_dir1 = os.path.join(args.save_dir, f"mcq_result_all.jsonl")
